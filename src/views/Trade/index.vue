<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in addressInfo" :key="address.id" @click="changeDefault(address)">
...
export default {
  ...
  computed: {
    ...
    // 将来提交订单最终选中的地址
    userDefaultAddress() {
      // arr.find()  查找数组中符合条件的第一个元素并返回
      // 仓库中的 addressInfo 还未请求到时（异步），这里会返回 undefined ,此时上边用这个计算属性就会报错，因此至少应该返回一个空对象
